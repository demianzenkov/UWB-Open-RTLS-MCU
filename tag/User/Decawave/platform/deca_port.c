...
volatile uint32_t signalResetDone;
...
//    HAL_NVIC_EnableIRQ(EXTI2_3_IRQn);     //pin #0 -> EXTI #0
...
{
  HAL_GPIO_WritePin(SPI1_NSS_DWM_GPIO_Port, SPI1_NSS_DWM_Pin, GPIO_PIN_RESET);
  Sleep(1);
  HAL_GPIO_WritePin(SPI1_NSS_DWM_GPIO_Port, SPI1_NSS_DWM_Pin, GPIO_PIN_SET);
