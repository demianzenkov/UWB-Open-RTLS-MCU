               ...
               const    uint8 *bodyBuffer)
{
    ...
    HAL_GPIO_WritePin(SPI1_NSS_DWM_GPIO_Port, SPI1_NSS_DWM_Pin, GPIO_PIN_RESET); /**< Put chip select line low */
    ...
    HAL_GPIO_WritePin(SPI1_NSS_DWM_GPIO_Port, SPI1_NSS_DWM_Pin, GPIO_PIN_SET); /**< Put chip select line high */
